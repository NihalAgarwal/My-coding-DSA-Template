 ...
 *
 * 13 % 3 = 1  ==> correct
 * 13 % -3 = 1 ( incorrect, the correct value should be -2 (acc. to python or some sites ), but as per Euclidean it should be 2 )
 * -13 % 3 = -1 ( incorrect, the correct value should be 2 )
 * -13 % -3 = -1 ( incorrect, according to Eucledian it should be 2, but -1 is correct according to python )
 *
